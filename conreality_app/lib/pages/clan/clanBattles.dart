...
class ClanBattlesTab extends StatefulWidget {
  ClanBattlesTab({Key? key}) : super(key: key);

  @override
  _ClanBattlesTabState createState() => _ClanBattlesTabState();
}

class _ClanBattlesTabState extends State<ClanBattlesTab> {
  @override
