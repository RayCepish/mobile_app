...
class _SignUpFormState extends State<SignUpForm> {
  ...
  Widget _buildIfYouHaveAnAccount() {
    return Container(
        ...
        child: Column(
          children: [
            Text("You have an account,", style: TextStyle(fontSize: 14.sp, color: Colors.grey),),
            FlatButton(onPressed: (){}, child: Text("LOG IN",style: TextStyle(fontSize: 14.sp, color: Colors.white),))
          ],
        ));
  }
